...
import lab3Kamandulis.MapKTUOAx;
...
public class Lab3Window extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if (source.equals(panButtons.getButtons().get(0))) {
                ...
                KsSwing.ou(taEvents, performValues());
    ...
    private String performValues() {
        List<Automobilis> autos = map.values();
        String result = "";
        for(Automobilis a : autos) {
            result += a.toString() + "\r\n";
        }
        return result;
    }
    ...
    private void createMap() {
        switch (cmbCollisionTypes.getSelectedIndex()) {
            case 0:
                ...
                break;
            case 3:
                map = new MapKTUOAx<>(initialCapacity);
                break;
    ...
    private void updateHashtableParameters(boolean colorize) {
        String[] parameters = new String[]{
            ...
            String.valueOf(map.getNumberOfCollisions()),
            String.valueOf(map.getEmptyChainCount())
