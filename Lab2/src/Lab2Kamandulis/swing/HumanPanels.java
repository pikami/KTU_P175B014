 ...
 */
public class HumanPanels extends JPanel {
     ...
     * @param columnWidth
     */
    public HumanPanels(String[] lblTexts, String[] tfTexts, int columnWidth) {
        super();
     ...
     * @param gridY
     */
    public HumanPanels(String[] btnNames, int gridX, int gridY) {
        super();
