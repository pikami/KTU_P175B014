...
public class Menu extends JMenuBar implements ActionListener {
    ...
    private final Lab2Window lab2Panel;

    public Menu(Lab2Window lab2Panel) {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (command.equals(jMenuItem11)) {
                ...
                KsSwing.ounerr(lab2Panel.getTaOutput(), MESSAGES.getString("msg1"));
            ...
            KsSwing.ounerr(lab2Panel.getTaOutput(), e.getMessage());
        } catch (Exception e) {
            KsSwing.ounerr(lab2Panel.getTaOutput(), MESSAGES.getString("msg9"));
