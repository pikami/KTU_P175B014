 ...
 * @author darius
 */
public class HumanMenu extends JMenuBar implements ActionListener {
    ...
    private final HumanWindow lab2Panel;

    public HumanMenu(HumanWindow lab2Panel) {
        this.lab2Panel = lab2Panel;
        initComponents();
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (command.equals(jMenuItem11)) {
                ...
                HumanKsSwing.ounerr(lab2Panel.getTaOutput(), MESSAGES.getString("msg1"));
            } else if (command.equals(jMenuItem13)) {
                System.exit(0);
            } else if (command.equals(jMenuItem21)) {
               JOptionPane.showOptionDialog(lab2Panel,
            ...
            HumanKsSwing.ounerr(lab2Panel.getTaOutput(), e.getMessage());
        } catch (Exception e) {
            HumanKsSwing.ounerr(lab2Panel.getTaOutput(), MESSAGES.getString("msg9"));
    ...
    private void fileChooseMenu() throws MyException {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            lab2Panel.treeGeneration(file.getAbsolutePath());
        }
    }
